          ...
          <form className="shadow-md p-4 flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-1">
                ...
                <div>
                  <div className="flex">
                    <input type="datetime-local" defaultValue={values.begin_date?.toLocaleString()} name="begin_date" onChange={handleChange}/> <span>Begin date</span>
                    </div>
                  <div className="flex"><input
                    name="end_date"
                    id="show_begin_date"
                    defaultValue={values.end_date?.toLocaleString() ?? ""}
                    type="datetime-local"
